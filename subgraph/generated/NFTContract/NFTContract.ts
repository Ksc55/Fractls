...
export class NFTContract extends ethereum.SmartContract {
  static bind(address: Address): NFTContract {
    return new NFTContract("NFTContract", address);
  }
  ...
  try_mint(to: Address, uri: string): ethereum.CallResult<BigInt> {
