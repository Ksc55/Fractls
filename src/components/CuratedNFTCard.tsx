    ...
    return (
        <div className="flex flex-col  justify-between    ">
            ...
            <div className="flex  items-center justify-between w-full space-y-2">
                ...
                <div className="inline-flex justify-end items-center pt-[0.4375rem] pr-[1.375rem] pb-2 pl-7 rounded-full border border-[#121212] text-[#121212] font-['Roboto'] text-xl leading-[150%]">
                    Stake
                </div>
            </div>
        </div>
