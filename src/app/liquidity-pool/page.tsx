...
export default function Page() {
  ...
  const latestIds: Array<number> =
    latestId === undefined ? [] : new Array(latestId).fill(0).map((_, i) => i);
    ...
    <div className="liquidity-pool mt-20">
      <div className="div w-full">
          ...
          <div className="frame-35">
            <div className="group-12">
              <div className="group-13">
                <a href="link_to_your_destination" className="text-wrapper-14">
                  Learn How It Works
                </a>
        ...
        <div className="flex justify-around my-5">
          {NFTListMinted.slice(0, 4).map((_nft, index) => (
            <CuratedNFTCard nft={_nft.result} index={index} />
          ))}
        </div>
        ...
        <div className={"flex justify-start gap-5"}>
          <div className="frame_39 inline-flex items-center p-2 rounded-full border-[0.5px] border-[#414141]">
            <div className="text-[#414141] font-['Roboto'] text-sm font-semibold leading-[120%]">
              Search Pool
            </div>
          ...
          <div className="inline-flex justify-center items-center gap-2.5 p-2 rounded-full border-[0.5px] border-[#414141]">
            <div className="text-[#414141] font-['Roboto'] text-sm font-semibold leading-[120%]">
              Filter by APR
            </div>
            <div className="flex justify-center items-center w-3 h-3">
        ...
        <section className="flex justify-center w-full frame-36 gap-10 py-20 my-20">
          <div className={"flex-col flex gap-3"}>
            ...
            <div className="p span w-3/6">
              Rewards When You Contribute To Pools
            </div>

            <div className="w-3/6 text-[#414141] font-['Roboto'] my-5">
              This helps you decide the trades you would participate in and plan
              your asset allocation.
            </div>
            <Image alt="action" src="/action3.png" width={200} height={200} />
          </div>
          <YieldCalculator />
        </section>
      </div>
...
const StakeCard = () => {
  const [stakeSwitch, setStakeSwitch] = useState<StakeSwitch>(
    StakeSwitch.STAKE
  );
  ...
  return (
    <div
      className={
        "bg-[#F1F1F1] rounded border-[0.5px] border-black w-1/3 p-5 h-86"
      }
    >
      <ToggleSelector
        button1={"Stake"}
        button2={"Unstake"}
        onChange={setStakeSwitch}
        value={0}
      />
      <AssetSelector
        value={asset}
        ...
        assets={assetsList}
        label={"I want to stake"}
      />
      <div className={"flex justify-between my-5"}>
        <div className="text-[#414141] font-['Roboto'] text-sm font-medium leading-[120%]">
          APR
        </div>
        <div className="text-[#414141] font-['Roboto'] text-sm font-light leading-[120%]">
          100%
        </div>
      </div>
      <Slider
        ...
        marks={daysMarks}
        step={7}
        maxValue={daysMarks[3].value}
        minValue={daysMarks[0].value}
      />
      <div className={"flex justify-center mt-10"}>
        <button
          className={
            "bg-customGreen-50 rounded-full px-4 h-10 font-light w-2/4"
          }
        >
          Stake
        </button>
...
const SummaryCard = () => {
  const [summarySwitch, setSummarySwitch] = useState<SummarySwitch>(
    SummarySwitch.SUMMARY
  );
...
const YieldCalculator = () => {
  ...
  return (
    <div className={"bg-[#f1f1f1] p-5"}>
      <div className="text-black font-['Roboto'] text-xl font-semibold text-center">
        Yield Calculator
      </div>
      <AssetSelector
        value={stakes}
      ...
      />
      <div className="text-[#414141] font-['Roboto'] text-sm font-medium py-3">
        APR
      </div>
